...
const GetEmployee = () => {
    ...
    const handleGetEmployees = async () => {
        try {
            const res = await axios.get("https://springboot-homework.herokuapp.com/employees/all");
    ...
    const handleDelete = async (empId) => {
        console.log(empId);
        try {
            await axios.delete(`https://springboot-homework.herokuapp.com/employees/${empId}`);
